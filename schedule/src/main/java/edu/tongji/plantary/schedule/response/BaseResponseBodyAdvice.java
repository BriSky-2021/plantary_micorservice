package edu.tongji.plantary.schedule.response;
...
@ControllerAdvice(basePackages = {"edu.tongji.plantary.user.controller","edu.tongji.plantary.schedule.controller"})
